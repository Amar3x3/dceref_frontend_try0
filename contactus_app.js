...
function reveal(){
    ...
    for (var  i=0; i<reveals.length; i++){
        ...
        console.log("wind"+windowheight)
        var revealtop = reveals[i].getBoundingClientRect().top - 150;
        console.log("rvltop"+revealtop)
        var revealpoint = 1;
...
function reveal_right(){
    ...
    for (var  i=0; i<reveals2.length; i++){
        ...
        var revealtop2 = reveals2[i].getBoundingClientRect().top - 150;
        var revealpoint2 = 0;
...
function reveal_left(){
    ...
    for (var  i=0; i<reveals3.length; i++){
        ...
        var revealtop3 = reveals3[i].getBoundingClientRect().top - 100;
        var revealpoint3 = 0;
